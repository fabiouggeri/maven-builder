         ...
         if (compiler.preCompilation(source, compilationRequest)) {
            ...
            if (compilationResult.isSuccessful()) {
               ...
               if (!compiler.posCompilation(source, compilationResult.getOutputFiles().get(0), compilationRequest)) {
                  projectResult.addError(source.getPath() + " compilado com sucesso, mas houve falha na pos-compilacao.");
                  error = true;
                  if (listener != null) {
               ...
               error = true;
               projectResult.addError(source.getPath() + " nao compilado.");
               if (listener != null) {
            ...
            error = true;
            projectResult.addError(source.getPath() + " nao compilado. Falha na pre-compilacao.");
            if (listener != null) {
