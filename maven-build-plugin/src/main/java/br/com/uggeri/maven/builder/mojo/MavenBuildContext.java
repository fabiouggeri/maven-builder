...
public class MavenBuildContext {
   ...
   public static MavenBuildContext createFromProject(MavenProject project) {
      ...
      final Plugin thisPlugin = project.getPlugin("br.com.uggeri.maven.builder:maven-builder-plugin");
      if (thisPlugin != null) {
    ...
    */
   protected boolean isNeedCompilation(File fileSource) {
    ...
    */
   protected boolean isCanPack(File fileSource) {
